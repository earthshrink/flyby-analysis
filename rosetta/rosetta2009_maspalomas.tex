...
\begin{axis}[
	...
	\node [small dot, pin = 30:{\tiny $-600~\milli\metre/\second$}]
		at (axis cs:2009-11-13 08:06:07, -600) {};

	\node [small dot, pin = -120:{\tiny $-4.385~\milli\metre/\second$}]
		at (axis cs:2009-11-13 10:10:07, -4.385) {};

	\node [rotate = 90, anchor = south] %coordinate, pin = above left:{\tiny LOS}]
		at (axis cs:2009-11-13 08:06:07, -450) {\tiny\it AOS Maspalomas};

	\node [rotate = -90, anchor = south] %coordinate, pin = above left:{\tiny LOS}]
		at (axis cs:2009-11-13 10:10:07, -450) {\tiny\it LOS Maspalomas};
\end{axis}
\end{tikzpicture}
\end{document}
