...
\begin{axis}[
	...
	\node [small dot, pin = 60:{\small $0.0395~\milli\metre/\second$}]
		at (axis cs:2009-11-13 07:29:25, 0.0395) {};

	\node [small dot, pin = 30:{\small $-530~\milli\metre/\second$}]
		at (axis cs:2009-11-13 07:49:25, -530) {};

	\node [rotate = 90, anchor = north] %coordinate, pin = above left:{\small LOS}]
		at (axis cs:2009-11-13 07:29:25, -800) {\small\it AOS New Norcia};
