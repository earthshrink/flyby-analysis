...
\begin{document}
\tikzsetnextfilename{fig_galileo_doppler_acceleration}
...
\node (jplh) at (0.20, 0.05) {%
	...
	\begin{axis}[
		...
		\addplot [thick, mark = none, red]
			...
			{galileo_canberra.t}
		;
		\addlegendentry[red, align = left] {Canberra acceleration};

		\addplot [thick, mark = none, blue]
			table [x index=0, y index=7, col sep=tab, skip first n=1]
			{galileo_goldstone.t}
		;
		\addlegendentry[blue, align = left] {Madrid acceleration};

		\addplot [thick, mark = none, teal]
			table [x index=0, y index=7, col sep=tab, skip first n=1]
			{galileo_madrid.t}
		;
		\addlegendentry[teal, align = left] {Goldstone acceleration};
	\end{axis}
	\end{tikzpicture}
};
\end{tikzpicture}
